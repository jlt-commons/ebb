;; Ported from missionary test/missionary/core_test.cljc (EPL 2.0).
;; missionary.core -> ebb.core, missionary.tck -> ebb.tck, and the
;; Cancelled predicate -> m/cancelled?.
(ns ebb.core-test
  (:require [ebb.core :as m]
            [ebb.tck :refer [if-try deftask defflow]]))
