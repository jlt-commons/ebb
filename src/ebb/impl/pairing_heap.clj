;; Derived from missionary/impl/PairingHeap.cljs (missionary, EPL 2.0).
;; Verbatim apart from ns and hint syntax -- pure structure, no host dependency.
(ns ^:no-doc ebb.impl.pairing-heap)
